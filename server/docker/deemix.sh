...
if [ ! -d "$CONFIGDIR" ]; then
	...
	docker run --name deemix -e ARL=ddd763a38fb3add792b3784c3867cc5b048cb00dffa390d6dd5f4a1ced138a091f706123901ee1159f711361d13422fff461ac606e16f4621a1a0d471598915088b1bf49ca95044f89ce4f29ae252d4d540c88f75dfa15f4d155163b6de3a824 -e UMASK_SET=022 -v $DOWNLOADSDIR:/downloads -v $CONFIGDIR:/config -p 6595:6595 -d registry.gitlab.com/bockiii/deemix-docker
fi
case $1 in
"start")
docker start deemix
